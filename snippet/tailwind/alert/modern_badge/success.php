...
return [
    ...
    'bodyContainer()' => [true],
    'bodyContainerClass()' => ['bg-green-800 p-2 flex items-center leading-none lg:inline-flex lg:rounded-full'],
    ...
    'class()' => ['bg-green-900 lg:px-4 py-4 text-center text-white'],
    'iconClass()' => ['not-italic'],
    'iconContainerClass()' => ['bg-green-500 flex font-bold ml-2 mr-3 px-2 py-1 rounded-full text-xs uppercase'],
