...
return [
    ...
    'bodyContainer()' => [true],
    'bodyContainerClass()' => ['bg-blue-100 border border-blue-400 border-t-0 rounded-b text-blue-700'],
    'bodyTemplate()' => ['{body}'],
    ...
    'headerContainer()' => [],
    'headerContainerClass()' => ['bg-blue-500 font-bold px-4 py-2 rounded-t text-white'],
